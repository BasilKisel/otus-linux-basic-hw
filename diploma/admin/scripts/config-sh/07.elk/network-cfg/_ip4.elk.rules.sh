...
iptables -t filter -A INPUT -p tcp -m multiport --dports 22,53,853,9100,5400,5601,9200 -j ACCEPT # ssh, dns, dns, prometheus-node-exporter, file-beats, kibana, elasticsearch
